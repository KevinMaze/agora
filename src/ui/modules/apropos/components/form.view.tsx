                ...
                >
                    <label htmlFor="name" className="">
                        <input
                            ...
                            required
                            className="w-70 sm:w-80 lg:w-100 h-10 border-2 border-primary bg-other rounded-xl"
                        />
                    </label>
                    <label
                        htmlFor="firstname"
                    ...
                    >
                        <textarea
                            ...
                            required
                            className="w-70 sm:w-80 lg:w-100 h-80 border-2 border-primary bg-other rounded-xl resize-none"
                        />
                    </label>
